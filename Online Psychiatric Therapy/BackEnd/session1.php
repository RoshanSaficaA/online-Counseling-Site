...
<h1>Therapist Details</h1><br>
      ...
      <div class="img-container">
        <img src="doc1.webp" alt="" id="person-img" />
      </div>

      <h4 id="author">Ms Mehak Bhandari </h4>
      <p id="job">Facilitator</p>
      <p id="info">
      I focus on a solution-oriented approach to help individuals<br> overcome their circumstances and realise 
      their true potential to lead a <br>healthy and fulfilling life.
      </p>
