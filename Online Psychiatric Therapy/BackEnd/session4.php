...
<div class="img-container">
        <img src="doc4.webp" alt="" id="person-img" />
      </div>

      <h4 id="author">Mr Issac Paul</h4>
      <p id="job">Counselling Psychotherapist</p>
      <p id="info">
      A compassionate and client-centered therapist who aims to provide a safe space of authenticity and support to clients who wish to explore and process their emotions to work towards overcoming or healing from their conflicts.
      </p>
